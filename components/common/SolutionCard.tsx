...
export default function SolutionCard({
  ...
  return (
    <>
      <div
        onClick={onclick}
        className="shadow rounded-xl overflow-auto md:overflow-hidden cursor-pointer relative solution-card bg-oklightgray mb-2 w-full text-left h-[330px] md:h-[315px] transform sm:translate-x-0 translate-x-[calc(-15%+0vw)]"
      >
